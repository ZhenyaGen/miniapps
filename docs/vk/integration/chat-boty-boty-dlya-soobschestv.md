...
**Раздел:** Интеграция → Чат-боты → Боты для сообществ  
...
ВКонтакте боты общаются с вашими клиентами через [сообщения сообществ](https://dev.vk.ru/ru/api/community-messages/getting-started). Это простой и привычный для пользователя интерфейс.
...
Чтобы научиться создавать ботов ВКонтакте, прочитайте [Быстрый старт](https://dev.vk.ru/ru/api/bots/getting-started).
