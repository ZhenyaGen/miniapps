...
**Раздел:** Интеграция → Сообщества и пользователи → События в сообществах  
...
Структура объекта в поле `object` зависит от типа уведомления. Ниже перечислены все типы уведомлений и соответствующие им объекты, которые поддерживаются в [Callback API](https://dev.vk.ru/ru/api/callback/getting-started) и [Bots Long](https://dev.vk.ru/ru/api/bots-long-poll/getting-started) [Poll API](https://dev.vk.ru/ru/api/bots-long-poll/getting-started).
...
- Для версий API ниже 5.103: [личное сообщение](https://dev.vk.ru/ru/reference/objects/message).
- Для версий API 5.103 и выше: объект, содержащий следующие поля:

| Поле | Тип | Описание |
|---|---|---|
| `message` | [Message](https://dev.vk.ru/ru/reference/objects/message) | Данные о сообщении, которое написал пользователь. |

`client_info` [ClientInfo](https://dev.vk.ru/ru/api/bots/getting-started#%D0%98%D0%BD%D1%84%D0%BE%D1%80%D0%BC%D0%B0%D1%86%D0%B8%D1%8F%20%D0%BE%20%D0%B4%D0%BE%D1%81%D1%82%D1%83%D0%BF%D0%BD%D1%8B%D1%85%20%D0%BF%D0%BE%D0%BB%D1%8C%D0%B7%D0%BE%D0%B2%D0%B0%D1%82%D0%B5%D0%BB%D1%8E%20%D1%84%D1%83%D0%BD%D0%BA%D1%86%D0%B8%D1%8F%D1%85) Информация о функциях, доступных пользователю.

message_reply

Новое исходящее сообщение.

Формат поля `object`: [личное сообщение](https://dev.vk.ru/ru/reference/objects/message).
...
`key` `string` Параметр, переданный в методе [`messages.allowMessagesFromGroup`](https://dev.vk.ru/ru/method/messages.allowMessagesFromGroup) [.](https://dev.vk.ru/ru/method/messages.allowMessagesFromGroup)
...
Действие с сообщением. Пользователь нажал на [Callback-кнопку](https://dev.vk.ru/ru/api/bots/development/keyboard#Callback-%D0%BA%D0%BD%D0%BE%D0%BF%D0%BA%D0%B8)
...
Формат поля `object`: [объект фотографии](https://dev.vk.ru/ru/reference/objects/photo).

photo_comment_new

Добавление комментария к фотографии.

Формат поля `object`: [объект комментария на стене](https://dev.vk.ru/ru/reference/objects/comment) с дополнительными полями:
...
Формат поля `object`: [объект аудиозаписи](https://dev.vk.ru/ru/reference/objects/audio).
...
Формат поля `object`: [объект видеозаписи](https://dev.vk.ru/ru/reference/objects/video).
...
Формат поля `object`: [объект записи на стене](https://dev.vk.ru/ru/reference/objects/post) с дополнительными полями:
...
`schedule_time` `integer` Дата и время, в которые будет опубликована запись, в формате [Unix](https://www.unixtimestamp.com) [Timestamp](https://www.unixtimestamp.com).
...
Формат поля `object`: [объект комментария в обсуждении](https://dev.vk.ru/ru/reference/objects/comment-topic) с дополнительными полями:
...
Формат поля `object`: [заказ](https://dev.vk.ru/ru/reference/objects/market-order).
...
- `user_id` — идентификатор пользователя, который внёс изменения.
- `photo` — объект, описывающий [фотографию](https://dev.vk.ru/ru/reference/objects/photo).
...
Создание подписки [VK Донат](https://dev.vk.ru/ru/api/donut/getting-started).
