...
**Раздел:** Мини-приложения → Разработка → Запуск → Экран запуска приложения  
**Источник:** документация VK для разработчиков (dev.vk.com)

---

Пока мини-приложение не проинициализировало соединение с платформой с помощью события

[`VKWebAppInit`](https://dev.vk.ru/ru/bridge/VKWebAppInit), пользователь будет видеть экран запуска. По умолчанию это [квадратная иконка](https://dev.vk.ru/ru/mini-apps/settings/general/design#%D0%98%D0%BA%D0%BE%D0%BD%D0%BA%D0%B0%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D0%B0%D1%82%D0%B0%D0%BB%D0%BE%D0%B3%D0%B0%20%D0%B8%20%D1%81%D0%BD%D0%B8%D0%BF%D0%BF%D0%B5%D1%82%D0%BE%D0%B2) [для каталога](https://dev.vk.ru/ru/mini-apps/settings/general/design#%D0%98%D0%BA%D0%BE%D0%BD%D0%BA%D0%B0%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D0%B0%D1%82%D0%B0%D0%BB%D0%BE%D0%B3%D0%B0%20%D0%B8%20%D1%81%D0%BD%D0%B8%D0%BF%D0%BF%D0%B5%D1%82%D0%BE%D0%B2) на белом фоне. Вместо статичной картинки вы можете добавить анимацию.
...
1. Откройте [список приложений](https://dev.vk.com/ru/admin/apps-list) и нажмите Настройки. В разделе [Оформление](https://dev.vk.ru/ru/mini-apps/settings/general/design) перейдите на вкладку Экран запуска.
