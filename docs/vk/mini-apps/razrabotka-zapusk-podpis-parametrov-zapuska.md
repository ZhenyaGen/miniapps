...
**Раздел:** Мини-приложения → Разработка → Запуск → Подпись параметров запуска  
**Источник:** документация VK для разработчиков (dev.vk.com)

---

Игры и мини-приложения ВКонтакте используют подпись [параметров](https://dev.vk.ru/ru/mini-apps/development/launch-params), чтобы защититься от подмены значений и возможной утечки данных.

1. При запуске приложения ВКонтакте вычисляет подпись с помощью [защищённого ключа](https://dev.vk.ru/ru/mini-apps/settings/development/keys#%D0%97%D0%B0%D1%89%D0%B8%D1%89%D1%91%D0%BD%D0%BD%D1%8B%D0%B9%20%D0%BA%D0%BB%D1%8E%D1%87) [доступа](https://dev.vk.ru/ru/mini-apps/settings/development/keys#%D0%97%D0%B0%D1%89%D0%B8%D1%89%D1%91%D0%BD%D0%BD%D1%8B%D0%B9%20%D0%BA%D0%BB%D1%8E%D1%87) из настроек. Этот ключ известен авторам игры или мини-приложения, но неизвестен третьим лицам.

Полученное значение передаётся приложению в [параметре запуска](https://dev.vk.ru/ru/mini-apps/development/launch-params) `sign`.
...
2. Для получившейся строки вычислите хеш-код, используя алгоритм SHA256 с методом HMAС. При расчётах используйте защищённый ключ из настроек вашего мини-приложения (раздел [Разработка → Ключи доступа](https://dev.vk.ru/ru/mini-apps/settings/development/keys), поле Защищённый ключ).
