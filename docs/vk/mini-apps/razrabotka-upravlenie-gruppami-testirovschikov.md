...
**Раздел:** Мини-приложения → Разработка → Управление группами тестировщиков  
**Источник:** документация VK для разработчиков (dev.vk.com)

---

Вы можете управлять [группами тестировщиков](https://dev.vk.ru/ru/mini-apps/settings/test-groups) мини-приложения c помощью методов API.

Важно! Методы для управления группами тестировщиков используются с [сервисным ключом](https://dev.vk.ru/ru/mini-apps/settings/development/keys#%D0%A1%D0%B5%D1%80%D0%B2%D0%B8%D1%81%D0%BD%D1%8B%D0%B9%20%D0%BA%D0%BB%D1%8E%D1%87) [доступа мини-приложения](https://dev.vk.ru/ru/mini-apps/settings/development/keys#%D0%A1%D0%B5%D1%80%D0%B2%D0%B8%D1%81%D0%BD%D1%8B%D0%B9%20%D0%BA%D0%BB%D1%8E%D1%87) и могут быть вызваны только на сервере.
