...
**Раздел:** VK Bridge → VKWebAppGyroscopeStop  
**Источник:** документация VK для разработчиков (dev.vk.com)

---

`VKWebAppGyroscopeStop` прекращает [отслеживание данных гироскопа](https://dev.vk.ru/ru/bridge/VKWebAppGyroscopeStart).
...
- С помощью событий `VKWebAppGyroscopeStopResult` и `VKWebAppGyroscopeStopFailed`.
