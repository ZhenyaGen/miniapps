...
**Раздел:** VK Bridge → VKWebAppAccelerometerStop  
**Источник:** документация VK для разработчиков (dev.vk.com)

---

`VKWebAppAccelerometerStop` прекращает [отслеживание данных акселерометра](https://dev.vk.ru/ru/bridge/VKWebAppAccelerometerStart).
...
- С помощью событий `VKWebAppAccelerometerStopResult` и
