...
**Раздел:** VK Bridge → VKWebAppCallStart  
**Источник:** документация VK для разработчиков (dev.vk.com)

---

`VKWebAppCallStart` используется при [интеграции звонков](https://dev.vk.ru/ru/mini-apps/development/calls-integration) в мини-приложение. Событие создаёт ссылку, по которой к звонку могут присоединяться пользователи, запустившие мини-приложение.
...
- С помощью событий `VKWebAppCallStartResult` и `VKWebAppCallStartFailed`.
...
`join_link` `string` URL, по которому можно подключить к звонку других участников с помощью события [`VKWebAppCallJoin`](https://dev.vk.ru/ru/bridge/VKWebAppCallJoin) [.](https://dev.vk.ru/ru/bridge/VKWebAppCallJoin)
...
- [VKWebAppCallJoin](https://dev.vk.ru/ru/bridge/VKWebAppCallJoin)
