...
**Раздел:** VK Bridge → VKWebAppGetEmail  
...
Совет. Если вашему мини-приложению требуется запросить не только адрес электронной почты, но и номер телефона, вызовите [карточку контактов](https://dev.vk.ru/ru/bridge/VKWebAppGetPersonalCard).
