...
**Раздел:** Использование API → Ключи доступа → Права доступа и приватность  
...
Для вызова методов VK API необходима предварительная [авторизация](https://dev.vk.ru/ru/api/access-token/getting-started) с получением ключа и определённых прав доступа. Эта информация отражена в верхней части страницы с описанием каждого метода.
...
| `ads` | (+ 32 768) (1 << 15) Доступ к расширенным методам работы с [рекламным](https://dev.vk.ru/ru/api/ads/getting-started) [API](https://dev.vk.ru/ru/api/ads/getting-started). |
...
| `app_widget` | (+ 64) (1 << 6) Доступ к [виджетам приложений сообществ](https://dev.vk.ru/ru/api/community-apps-widgets/getting-started). Это право можно запросить с помощью события |

`VKWebAppGetCommunityToken`. Подробнее — в разделе [Ключ доступа сообщества](https://dev.vk.ru/ru/api/access-token/community-token#%D0%A1%D0%BE%D0%B1%D1%8B%D1%82%D0%B8%D0%B5%20VK%20Bridge).
...
Некоторые разделы данных ВКонтакте также могут быть скрыты настройками приватности: например, доступ к видеозаписи только для подписчиков сообщества. В этом случае, даже если есть право доступа `video`, объект может быть скрыт. Подробнее — в разделе [Настройки](https://dev.vk.ru/ru/reference/objects/privacy) [приватности](https://dev.vk.ru/ru/reference/objects/privacy).
