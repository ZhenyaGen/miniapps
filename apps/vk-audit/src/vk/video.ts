...
/**
 * Сколько роликов забираем максимум.
 *
 * Тысяча — это десять запросов, около трёх секунд. Четырёхсот не хватало:
 * у страницы, которая живёт клипами, за год их выходит больше, и разбор
 * молча обрывался на середине — суммы получались в разы меньше настоящих.
 */
const VIDEO_MAX = 1000;
