...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    screen: '8-roliki.png',
    lead: 'Обычные видео и все комментарии — со стены и из-под роликов. '
    ...
    points: [
      ...
      ['Только своё', 'чужие ролики, добавленные к себе в раздел «Видео», в разбор не идут — иначе медианы и «лучшие ролики» уезжают в чужие цифры. Сколько их было, вкладка скажет отдельно'],
    ],
  },
  {
    id: 'rivals',
