...
const STEPS: Step[] = [
  {
    ...
    points: [
      ...
      ['Забрать файлом', 'внизу отчёта: таблица CSV (каждая строка — запись, клип, видео или снимок, одними столбцами — сразу строится сводная) и PDF через печать браузера'],
    ],
  },
  {
    id: 'summary',
