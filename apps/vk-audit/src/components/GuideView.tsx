...
const STEPS: Step[] = [
  {
    ...
    points: [
      ...
      ['Доступ к данным', 'внутри ВКонтакте отдельного входа нет — приложение узнаёт вас по параметрам запуска. Разрешение на чтение записей ВК спросит один раз, когда нажмёте «собрать»'],
      ['«Открыть демо-отчёт»', 'показывает все экраны на вымышленном сообществе — вообще без обращений к ВКонтакте'],
    ],
  },
  {
    id: 'summary',
  ...
  },
  {
    id: 'clips',
    tab: 'Клипы',
    title: 'Клипы отдельно',
    screen: '5-kontent.png',
    lead: 'Клип живёт не в ленте сообщества, а в ленте клипов: охват '
      + 'почти не зависит от числа подписчиков, зато сильно — от первых секунд.',
    points: [
      ['Выстрелы', 'клипы, набравшие больше трёх медиан. У клипов важен не средний уровень, а частота попаданий: лента раздаёт охват рывками'],
      ['Разброс', 'во сколько раз лучший клип обошёл серединный. Пять и больше — норма для этой ленты'],
      ...
      ['Как менялось', 'медиана просмотров по месяцам — видно, растёт лента к вам или остывает'],
    ],
  },
  {
    id: 'video',
