...
/**
 * Кнопка «Поддержать проект». Пусто — кнопки нет.
 *
 * Ссылку держим внутри ВКонтакте — VK Донат сообщества
 * (`https://vk.ru/donut/имя_сообщества`). Внешние платёжные ссылки в мини-
 * приложении модерация может прочитать как обход платежей платформы.
 * Оплата голосами (`VKWebAppShowOrderBox`) здесь не подходит: ей нужен
 * сервер, который отвечает на уведомления о заказе, а приложение статическое.
 */
