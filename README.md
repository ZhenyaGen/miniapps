...
Все инструкции — в папке **[`АВТОРУ/`](АВТОРУ/README.md)**: как запустить
и обслуживать, как пользоваться приложением, план раскатки и монетизации,
готовые посты и сторис, тексты для карточки в каталоге, анкеты обратной
связи и разбор по авторским правам.
...
[АВТОРУ/АВТОРСТВО.md](АВТОРУ/АВТОРСТВО.md) — чем подтверждается авторство
и что делать, если код скопировали.
